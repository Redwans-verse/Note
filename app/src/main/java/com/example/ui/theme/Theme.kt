...
private val DarkColorScheme = darkColorScheme(
  ...
  secondary = EggAmberSecondaryDark,
  onSecondary = EggAmberOnSecondaryDark,
  secondaryContainer = EggAmberSecondaryContainerDark,
  onSecondaryContainer = EggAmberOnSecondaryContainerDark,
...
private val LightColorScheme = lightColorScheme(
  ...
  secondary = EggAmberSecondary,
  onSecondary = EggAmberOnSecondary,
  secondaryContainer = EggAmberSecondaryContainer,
  onSecondaryContainer = EggAmberOnSecondaryContainer,
...
fun MyApplicationTheme(
  ...
  dynamicColor: Boolean = false, // Keep farm branding consistent
